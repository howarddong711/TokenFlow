...
use crate::core::{CostSnapshot, OAuthCredentials, ProviderError, RateWindow, UsageSnapshot};
...
impl CodexApi {
    ...
    pub async fn fetch_usage(
        ...
        self.fetch_usage_with_credentials(&creds).await
    }

    pub async fn fetch_usage_with_oauth(
        &self,
